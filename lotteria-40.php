...
<head>
  ...
  <title>Lotteria 40 Numeri &mdash; LuckyBet</title>
...
<div class="pg">
  ...
  <div class="game-area">
    <div class="card">
      <div class="card-title">Lotteria 40 Numeri</div>
      <div class="card-sub">Scegli 6 numeri da 1 a 40 e premi Gioca</div>

      <div id="result-msg" class="result-msg"></div>

      <div class="num-grid lotto40">
        <?php for ($i = 1; $i <= 40; $i++): ?>
    ...
    <div class="card">
      ...
      <div class="prizes">
        <div class="prize-row" id="pr2"><span class="prize-lbl">2 numeri</span><span class="prize-val" id="pv2">3</span></div>
        <div class="prize-row" id="pr3"><span class="prize-lbl">3 numeri</span><span class="prize-val" id="pv3">16</span></div>
        <div class="prize-row" id="pr4"><span class="prize-lbl">4 numeri</span><span class="prize-val" id="pv4">220</span></div>
        <div class="prize-row" id="pr5"><span class="prize-lbl">5 numeri</span><span class="prize-val" id="pv5">9.500</span></div>
        <div class="prize-row" id="pr6"><span class="prize-lbl">6 numeri</span><span class="prize-val" id="pv6">1.900.000</span></div>
      </div>
    </div>

    <div class="instr">
      <h3>Come si gioca?</h3>
      <p>Versione ridotta con soli 40 numeri. Scegli 6 numeri, imposta la puntata con i pulsanti +/&minus;, poi premi Gioca. I premi si moltiplicano per la puntata scelta. Chiunque indovini tutti e 6 vince 1.900.000 &times; la puntata.</p>
    </div>
  </div>
</div>
...
let selected = 0;
let puntata  = 1;
const BASE   = {2: 3, 3: 16, 4: 220, 5: 9500, 6: 1900000};
...
function resetGame() {
  selected = 0;
  for (let i = 1; i <= 40; i++) document.getElementById('c' + i).classList.remove('sel');
  for (let i = 0; i < 6; i++) {
    const b = document.getElementById('wb' + i);
    b.textContent = '?'; b.classList.remove('drawn');
  }
...
function saveScore() {
  ...
  window.location.href = 'lotteria-40.php?credito2=' + s;
}
